...
class MainWindow(QMainWindow):
    ...
    def _create_menus(self) -> None:
        ...
        logger.debug(f"Created File menu: {self.file_menu.title()}")

        # Edit menu (placeholder)
        self.edit_menu = menubar.addMenu("&Edit")
        self.edit_menu.setObjectName("edit_menu")
        placeholder_edit = QAction("(Coming in Phase 2)", self)
        placeholder_edit.setEnabled(False)
        self.edit_menu.addAction(placeholder_edit)
        logger.debug(f"Created Edit menu: {self.edit_menu.title()}")
        ...
        self.view_menu.addAction(self.tool_dock.toggleViewAction())
        logger.debug(f"Created View menu: {self.view_menu.title()}")

        # Tools menu (placeholder)
        self.tools_menu = menubar.addMenu("&Tools")
        self.tools_menu.setObjectName("tools_menu")
        placeholder_tools = QAction("(Coming in Phase 2)", self)
        placeholder_tools.setEnabled(False)
        self.tools_menu.addAction(placeholder_tools)
        logger.debug(f"Created Tools menu: {self.tools_menu.title()}")

        # Help menu (placeholder)
        self.help_menu = menubar.addMenu("&Help")
        self.help_menu.setObjectName("help_menu")
        placeholder_help = QAction("(Coming in Phase 2)", self)
        placeholder_help.setEnabled(False)
        self.help_menu.addAction(placeholder_help)
        logger.debug(f"Created Help menu: {self.help_menu.title()}")
